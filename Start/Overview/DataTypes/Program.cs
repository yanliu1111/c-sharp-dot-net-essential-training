...
//reason, one unchanged, one changed, because struct is value type, class is reference type which any changed to the object that is being referred by the argument to the function, those changes take effect outside the function as well.